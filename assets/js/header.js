...
//     { id: 2, name: 'Доставка', href: '/pages/delivery/index.html' },
//     { id: 2, name: 'О нас', href: '/pages/delivery/index.html' },
//     { id: 2, name: 'Новости', href: '/pages/delivery/index.html' },
// ]
...
//     if (!navList) throw new Error(' не найден элемент с классом .header__list')
//     nav.forEach(item => {
...
//     /* const navList = [
//         { id: 1, href: '#', name: 'Роллы' },
//         { id: 2, href: '#', name: 'Суши' },
//         { id: 3, href: '#', name: 'Сеты' },
//         { id: 4, href: '#', name: 'Боулы' },
//         { id: 5, href: '#', name: 'Напитки' },
//         { id: 6, href: '#', name: 'Соусы' },
//         { id: 6, href: '#', name: 'Неизвестно' },
//         { id: 6, href: '#', name: 'Неизвестно' },
//     ] */


//     const nav = `<div class="categories-nav">
